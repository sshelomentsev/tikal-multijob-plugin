...
public class PhaseJobsConfig implements Describable<PhaseJobsConfig> {
    ...
    public List<Action> getActions(AbstractBuild build, TaskListener listener,
        ...
        if (isCurrentInclude) {
            ...
            if (defaultParameters != null) {
                MultiJobParametersAction multiJobParametersAction
                        = new MultiJobParametersAction(defaultParameters.getParameters());
                if (params != null) {
                    params = mergeParameters(params, multiJobParametersAction);
                } else {
                    params = multiJobParametersAction;
                }
            }
        }
    ...
    public enum IgnoreJobResult {
        NEVER("Never") {
            @Override
            public Result getMinSuccessResult() {
